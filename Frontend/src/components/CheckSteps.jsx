  ...
  return (
    <section className="flex gap-2 mb-3" >
        <div>
            { step1 ? 
            (
                <Link className='bg-slate-500 text-white py-1 px-2 rounded-full font-medium text-sm' to='/login'> <button >Login</button> </Link>
            ) : 
            (
        ...
        <div>
            { step2 ? 
            (
                <Link className='bg-slate-500 text-white py-1 px-2 rounded-full font-medium text-sm' to='/shipping'> <button>Shipping</button> </Link>
            ) : 
            (
        ...
        <div>
            { step3 ? 
            (
                <Link className='bg-slate-500 text-white py-1 px-2 rounded-full font-medium text-sm' to='/payment'> <button>Payment</button> </Link>
            ) : 
            (
        ...
        <div>
            { step4 ? 
            (
                <Link className='bg-slate-500 text-white py-1 px-2 rounded-full font-medium text-sm' to='/placeorder'> <button>Place Order</button> </Link>
            ) : 
            (
